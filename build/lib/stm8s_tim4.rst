      ...
      009B6D 81               [ 4]   64 	ret
                                     ...
                                     68 ;	-----------------------------------------
      009B6E                         69 _TIM4_TimeBaseInit:
                                     70 ;	lib/stm8s_tim4.c: 26: TIM4->PSCR = (uint8_t)(TIM4_Prescaler);
      009B6E AE 53 47         [ 2]   71 	ldw	x, #0x5347
      009B71 7B 03            [ 1]   72 	ld	a, (0x03, sp)
      009B73 F7               [ 1]   73 	ld	(x), a
                                     74 ;	lib/stm8s_tim4.c: 28: TIM4->ARR = (uint8_t)(TIM4_Period);
      009B74 AE 53 48         [ 2]   75 	ldw	x, #0x5348
      009B77 7B 04            [ 1]   76 	ld	a, (0x04, sp)
      009B79 F7               [ 1]   77 	ld	(x), a
      009B7A 81               [ 4]   78 	ret
      ...
      009B9D 81               [ 4]  126 	ret
                                    ...
                                    130 ;	-----------------------------------------
      009B9E                        131 _TIM4_ClearFlag:
                                    132 ;	lib/stm8s_tim4.c: 67: TIM4->SR1 = (uint8_t)(~TIM4_FLAG);
      009B9E 7B 03            [ 1]  133 	ld	a, (0x03, sp)
      009BA0 43               [ 1]  134 	cpl	a
      009BA1 AE 53 44         [ 2]  135 	ldw	x, #0x5344
      009BA4 F7               [ 1]  136 	ld	(x), a
      009BA5 81               [ 4]  137 	ret
                                    138 ;	lib/stm8s_tim4.c: 70: void TIM4_ClearITPendingBit(TIM4_IT_TypeDef TIM4_IT)
                                    139 ;	-----------------------------------------
                                    140 ;	 function TIM4_ClearITPendingBit
                                    141 ;	-----------------------------------------
      009BA6                        142 _TIM4_ClearITPendingBit:
                                    143 ;	lib/stm8s_tim4.c: 73: TIM4->SR1 = (uint8_t)(~TIM4_IT);
      009BA6 7B 03            [ 1]  144 	ld	a, (0x03, sp)
      009BA8 43               [ 1]  145 	cpl	a
      009BA9 AE 53 44         [ 2]  146 	ldw	x, #0x5344
      009BAC F7               [ 1]  147 	ld	(x), a
      009BAD 81               [ 4]  148 	ret
                                    149 	.area CODE
