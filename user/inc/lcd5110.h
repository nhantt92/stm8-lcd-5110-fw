/**
  ...
  * @brief   This file header lcd5110.h
  * @Last Modified by:   nhantt
  * @Last Modified time: 2017-12-29 23:07:13
   ******************************************************************************
*/
...
#define SET_SCLK GPIO_WriteHigh(GPIOC, LCD_SCLK_PIN)
#define RESET_SCLK GPIO_WriteLow(GPIOC, LCD_SCLK_PIN)
...
#define OK 0 // 0K
#define OUT_OF_BORDER 1 // Out of OUT_OF_BORDER
...
typedef enum
{
  ...
  FONT_4X = 2  // Large font size (font number only)
} LcdFontSize;
...
static const unsigned char FontLookup [][5] =
{
   ...
   { 0x06, 0x09, 0x09, 0x06, 0x00 },   // "ãðàäóñû" 0x7F 127
